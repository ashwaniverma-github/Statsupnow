...
import SubscribeButton from './sm-components/subscribeButton';
...
export default function Subscriptions() {
  ...
  if (loading) {
    return <div className="flex justify-center items-center min-h-screen"><Loader2 className="animate-spin h-6 w-6 mr-2" /><span>Loading...</span></div>;
  }
        ...
        {channels.map((channel) => (
          <div key={channel.id} className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-600">{channel.snippet.description.slice(0, channel.snippet.description.indexOf('.'))}</p>
              <div className="mt-4">
